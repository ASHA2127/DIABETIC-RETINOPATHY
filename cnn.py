...
#Setting up constants for directory paths
TRAIN_DIR = 'train'
TEST_DIR = 'test'
...
# Function to process training data by labeling images and resizing them.
...
#Function to process test data by resizing images.
